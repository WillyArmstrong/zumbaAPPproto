...
namespace zumbaAPP
{
    public partial class ClientInfo : Form
    {
        ...
        private void GetMemberInfo(int MemberID)
        {
            ...
            {
                string query = "SELECT * FROM [zumba connessions] WHERE MemberID = @MemberID";
                ...
                using (SqlCommand command = new SqlCommand(query, connection))
                {
                    ...
                    try
                    {
                        ...
                        if (reader.Read())
                        {
                            this.MemberID.Text = reader["MemberID"].ToString();
                            pnTextbox.Text = reader["PhoneNumber"].ToString();
                            fnTextbox.Text = reader["First"].ToString();
